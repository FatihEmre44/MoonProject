...
export default function MenuTrigger({ isPanelOpen, onClick }) {
    return (
        <motion.button
            ...
            onClick={onClick}
            className="menu-lines pointer-events-auto absolute left-6 top-6 flex h-12 w-12 flex-col items-center justify-center gap-1.5 rounded-xl border border-cyan-300/40 bg-black/35 p-3 backdrop-blur-lg"

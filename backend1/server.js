...
app.post('/api/plan-route', (req, res) => {
    try {
        const { mapGrid, startNode, targetNode } = req.body;
        ...
        const result = astar(mapGrid, startNode, targetNode);
...
app.post('/api/plan-multi-route', (req, res) => {
    try {
        const { mapGrid, waypoints } = req.body;
        ...
        // ── Çoklu A* Çalıştır ─────────────────────────────
        const result = astarMulti(mapGrid, waypoints);
